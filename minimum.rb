...
#    for(var current_index = minIndex + 1; current_index <= (array.length - 1); current_index++)
#    {
#        println("Current index" + current_index);
#        if(array[current_index] < minValue) {
#            println("Smaller:" + array[current_index] + "<" +  minValue);
#            minIndex = current_index;
#            minValue = array[current_index];
#        }
#    }
#    println(minIndex);
#    return minIndex;
